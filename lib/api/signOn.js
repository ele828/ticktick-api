...
function signOn(axios, tokenCachePath) {
  var _this = this;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.t0 = JSON;
              _context.next = 3;
              return (0, _fs.readFile)(_path2.default.join(tokenCachePath));
            ...
            case 9:
              ...
              _context.next = 13;
              return (0, _fs.writeFile)(_path2.default.join(tokenCachePath), JSON.stringify(_token));
